...
class NakeneController extends Controller
{
    ...
    curl_setopt_array($curl1, [
        CURLOPT_URL => "http://127.0.0.1:8000/api/apibarang",
    ...
    curl_setopt($curl1, CURLOPT_TIMEOUT, 30); // Maksimal 30 detik
    curl_setopt($curl1, CURLOPT_CONNECTTIMEOUT, 10); // Timeout koneksi 10 detik
